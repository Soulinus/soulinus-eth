      ...
      >
        <ul className="bg-gray-800 px-4 py-2">
          <li>
            <Link
              href="/signin"
              className="flex w-full justify-center py-2 font-medium text-blue-400 hover:text-gray-200"
          ...
          <li>
            <Link
              href="/signup"
              className="my-2 inline-flex w-full items-center justify-center rounded-sm border border-transparent bg-blue-400 px-4 py-2 font-medium text-white transition duration-150 ease-in-out hover:bg-blue-600"
              onClick={() => setMobileNavOpen(false)}
            >
              Sign up
            </Link>
